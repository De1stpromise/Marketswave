...
async function main() {
  ...
  try {
    ...
    console.log('\n--- Sheen audit ---\n');
    const sheen = runChild('audit-glass-sheen.mjs', { SHEEN_PAGES: 'admin-products.html', SHEEN_BOOTSTRAP_JS: bootstrap }, 'audit-glass-sheen');
    ...
    check('★ 1440px: THE PRODUCTS PAGE MOUNTS THE SHARED ADMIN NAV — ten items, a real rail with width',
