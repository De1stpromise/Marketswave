...
const EU_STOCKS_TIER1 = [
  ...
  EU('NVS', 'Novartis AG', 'Swiss pharmaceutical group developing and selling prescription medicines.', 'NOVN.SW', 'SIX Swiss Exchange', 'NYSE ADR'),
...
const EU_STOCKS_TIER2 = [
  ...
  EU('PRNDY', 'Pernod Ricard SA', 'French producer and distributor of wines and spirits.', 'RI.PA', 'Euronext Paris', 'OTC ADR'),
